	...
	************************************************************************************************************/	
	/*
		fixes for TYPO3
		(c) www.4many.net, July 2006 Peter Russ, peter.russ@4many.net
	*/
	
	/*PRS+  20060719 */
	var extensionPath='typo3conf/ext/ch_mandelbrot/res/crop-image/';
	var md5Hash='';
	/*PRS-  20060719 */
	
	var crop_script_alwaysPreserveAspectRatio = false;
	var crop_script_fixedRatio = 1;	 // Fixed aspect ratio(example of value: 1.5). Width of cropping area relative to height(1.5 means that the width is 150% of the height)
